                ...
                {items.map((item, index) => (
                    <div key={`item-${index}`}
                        ...
                        <input id={`navbar-name-${index}`} aria-label={t("nameLabel")} name={`name-${index}`}
                               ...
                               className="w-0 grow text-sm shadow-sm appearance-none border rounded-sm py-2 px-3 bg-bg-light text-text-content focus:outline-hidden focus:shadow-link-content focus:border-link-content"/>
                        <input id={`navbar-url-${index}`} aria-label={t("urlLabel")} name={`url-${index}`}
                               ...
                               className="ml-4 w-0 grow text-sm shadow-sm appearance-none border rounded-sm py-2 px-3 bg-bg-light text-text-content focus:outline-hidden focus:shadow-link-content focus:border-link-content"/>
                        <button
                            className="ml-4 w-20 rounded-md outline outline-1 outline-button-bg bg-bg-light hover:bg-bg-hover focus:bg-bg-hover px-3 py-2 text-sm text-text-content shadow-xs"
